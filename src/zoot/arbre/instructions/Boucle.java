...
public class Boucle extends Instruction {
    ...
    public Boucle(int n, Expression exp, ArbreAbstrait bloc, int numCarac) {
        super(n);
        this.exp = exp;
        this.bloc = bloc;
    ...
    public String toMIPS(String... registres) {
        ...
        sb.append("Boucle").append(noLigne).append("Car").append(numCarac).append(":\n");
        sb.append(exp.toMIPS("$v0", "$t0", "$t1", "$t2", "$t3", "$t4", "$t5", "$t6", "$t7"));
        sb.append("\n# Initialiser $t8 avec la valeur vrai\n");
        sb.append("\tla $t8, vrai\n");
        sb.append("\tbeq $t8, $v0, FinBoucle").append(noLigne).append("Car").append(numCarac).append("\n");
        sb.append(bloc.toMIPS());
        sb.append("\tj Boucle").append(noLigne).append("Car").append(numCarac).append("\n");
        sb.append("FinBoucle").append(noLigne).append("Car").append(numCarac).append(": \n");
        return sb.toString();
    }
}